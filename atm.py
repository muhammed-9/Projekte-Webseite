...
import os
#==========================================
# Definieren von Kontoinhabern, Pin's und Kontoständen
#==========================================
...
count = 0
#==========================================
# while loop kontrolliert Kontoinhaber nach Existenz
#==========================================
while True:
	user = input('\nENTER USER NAME: ')
	user = user.lower()
...
while count < 3:
	...
	if pin.isdigit():
		...
		count += 1
#==========================================
# Nach Überprüfung der PIN wird fortgesetzt oder jeweils abgebrochen
#==========================================
if count == 3:
	print('-----------------------------------')
	print('***********************************')
...
print('----------ATM SYSTEM-----------')
#==========================================
# Hauptmenü Auswahl zwischen ['s', 'w', 'l', 'p', 'q']
#==========================================
while True:
	#os.system('clear')
	print('-------------------------------')
